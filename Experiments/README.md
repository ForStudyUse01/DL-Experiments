...
| 10 | [Responsible AI & Model Evaluation](experiment-10-responsible-ai) | Titanic (reuses Exp1 pipeline) | [01_model_evaluation.ipynb](experiment-10-responsible-ai/notebooks/01_model_evaluation.ipynb) | RandomForest: 77.61% accuracy; precision/recall/F1 0.798/0.855/0.826 (Not Survived), 0.733/0.647/0.688 (Survived). Bias check by Sex: 79.17% (female) vs. 76.74% (male), 2.4pp gap. Explainability via feature importances + a manual LIME-style local explanation (SHAP's `numba`/`llvmlite` dependency is blocked by this machine's Windows Application Control policy) — see [results.csv](experiment-10-responsible-ai/results.csv) / [bias_report.csv](experiment-10-responsible-ai/bias_report.csv) |
